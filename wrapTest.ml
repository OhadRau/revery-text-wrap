...
let () =
  ...
  print_endline "------------------";
  wrap ~width_of_char ~max_width:100.0 ~debug:true "0" |> List.iter print_endline;
  ...
  print_endline "==================";
  wrap ~width_of_char ~max_width:5.0 ~hyphenate:true wrapInput |> List.iter print_endline;
  print_endline "==================";
  wrap ~width_of_char ~max_width:10.0 ~hyphenate:true wrapInput |> List.iter print_endline;
  print_endline "==================";
  wrap ~width_of_char ~max_width:15.0 wrapInput |> List.iter print_endline;
  print_endline "==================";
  wrap ~width_of_char ~max_width:40.0 wrapInput |> List.iter print_endline
